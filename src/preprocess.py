...
# --- Fix for import error: Add the parent directory to the system path ---
# This allows the script to find and import preprocessor.py
current_dir = os.path.dirname(os.path.abspath(__file__))
parent_dir = os.path.dirname(current_dir)
sys.path.append(os.path.join(parent_dir, 'src'))

# Import the preprocessor pipeline from preprocessor.py
try:
    from preprocess import create_preprocessor_pipeline
except ImportError:
    print("Error: preprocessor.py not found. Please ensure it is in the same directory.")
    sys.exit()
...
# Drop duplicate rows from both training and testing datasets for data integrity
...
# Create a full pipeline that includes both preprocessing and the model
